## This script will perform Laplace Criteron:
# It prompts the user to input numbers and names and then prescribes action
# The Laplace Criterion assumes that the prior distribution for the states
# of nature is the one with all values equal.
...
print("This script performs Laplace Criterion on an action set\n")
a0 = True
while a0 == True:
...
print('\n---All states of nature equally probable---\n')
P_THETA = THETADist(THETA)
...
print('Expected loss of each action using the Laplace Criterion is: ')
